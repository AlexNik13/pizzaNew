...
public class PriceIngredient {
    public static final Map<String, Double> price = new TreeMap<>();
    ...
    static {
        ...
        price.put("Огурцы маринованные", 70.);
        price.put("Перец черный молотый", 214.);
        price.put("Помидоры", 70.);
        price.put("Помидоры Черри", 98.);
        price.put("Соль", 24.);
        price.put("Сухарики", 40.);
        price.put("Сыр", 150.);
